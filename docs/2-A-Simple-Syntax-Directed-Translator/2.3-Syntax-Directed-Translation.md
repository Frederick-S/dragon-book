...
## 2.3.3
```
romanNumeral -> a b c d {print(a.roman || b.roman || c.roman || d.roman)}
a -> less_than_four {a.roman = less_than_four.int * 'M'}
b -> less_than_four {b.roman = less_than_four.int * 'C'}
b -> four {b.roman = 'CD'}
b -> less_than_nine {b.roman = 'D' || (less_than_nine.int - 5) * 'C'}
b -> nine {b.roman = 'CM'}
c -> less_than_four {c.roman = less_than_four * 'X'}
c -> four {c.roman = 'XL'}
c -> less_than_nine {c.roman = 'L' || (less_than_nine.int - 5) * 'X'}
c -> nine {c.roman = 'XC'}
d -> less_than_four {d.roman = less_than_four.int * 'I'}
d -> four {d.roman = 'IV'}
d -> less_than_nine {d.roman = 'V' || (less_than_nine.int - 5) * 'I'}
d -> nine {d.roman = 'IX'}
less_than_four -> 0 | 1 | 2 | 3
four -> 4
less_than_nine -> 5 | 6 | 7 | 8
nine -> 9
```
